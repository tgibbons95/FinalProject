...
private:
	...
	bool chekcForWin(int, int);	//take indices of last move so as to not recheck entire board
	...
	char symbol(int);			// returns the proper symbol to be displayed on the board
